...
from vllm_module.logger import enable_trace_function_call, init_logger
...
def is_cpu() -> bool:
    ...
    try:
        return "cpu" in version("vllm_module")
...
def is_openvino() -> bool:
    from importlib.metadata import PackageNotFoundError, version
    try:
        return "openvino" in version("vllm_module")
    except PackageNotFoundError:
        return False
...
def is_xpu() -> bool:
    ...
    # todo
    # is_xpu_flag = "xpu" in version("vllm_module")
    is_xpu_flag=False
    # vllm_module is not build with xpu
    if not is_xpu_flag:
        return False
    try:
...
def get_vllm_instance_id() -> str:
    ...
    """
    return envs.VLLM_INSTANCE_ID or f"vllm_module-instance-{random_uuid()}"
...
def enable_trace_function_call_for_thread() -> None:
    ...
    if envs.VLLM_TRACE_FUNCTION:
        ...
        log_path = os.path.join(tmp_dir, "vllm_module", get_vllm_instance_id(),
                                filename)
