...
from vllm_module.sequence import (IntermediateTensors, PoolerOutput, SequenceData,
                                  SequenceGroupMetadata)
from vllm_module.worker.model_runner import (GPUModelRunnerBase, ModelInputForGPU,
