...
from vllm_module.attention import AttentionMetadata, get_attn_backend
from vllm_module.config import (CacheConfig, DeviceConfig, LoadConfig, LoRAConfig,
                                ModelConfig, MultiModalConfig, ParallelConfig,
                                PromptAdapterConfig, SchedulerConfig)
from vllm_module.distributed import get_pp_group
from vllm_module.distributed.parallel_state import graph_capture
from vllm_module.inputs import INPUT_REGISTRY
from vllm_module.logger import init_logger
from vllm_module.lora.layers import LoRAMapping
from vllm_module.lora.request import LoRARequest
from vllm_module.lora.worker_manager import LRUCacheWorkerLoRAManager
from vllm_module.model_executor import SamplingMetadata
from vllm_module.model_executor.model_loader import get_model
from vllm_module.model_executor.model_loader.tensorizer import TensorizerConfig
from vllm_module.model_executor.models.interfaces import (supports_lora,
                                                          supports_vision)
from vllm_module.model_executor.models.utils import set_cpu_offload_max_bytes
from vllm_module.multimodal import (MULTIMODAL_REGISTRY, BatchedTensorInputs,
                                    MultiModalInputs)
from vllm_module.prompt_adapter.layers import PromptAdapterMapping
from vllm_module.prompt_adapter.request import PromptAdapterRequest
from vllm_module.prompt_adapter.worker_manager import (
    LRUCacheWorkerPromptAdapterManager)
from vllm_module.sampling_params import SamplingParams
from vllm_module.sequence import (IntermediateTensors, SamplerOutput,
                                  SequenceGroupMetadata)
from vllm_module.utils import (CudaMemoryProfiler, flatten_2d_lists,
                               get_kv_cache_torch_dtype, is_hip,
                               is_pin_memory_available)
from vllm_module.worker.model_runner_base import (
...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def save_sharded_state(
        ...
        from vllm_module.model_executor.model_loader.loader import ShardedStateLoader
    ...
    def save_tensorized_model(
        ...
        from vllm_module.model_executor.model_loader.loader import TensorizerLoader
