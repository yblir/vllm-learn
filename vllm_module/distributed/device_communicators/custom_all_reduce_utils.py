...
from vllm_module.distributed.device_communicators.cuda_wrapper import CudaRTLibrary
from vllm_module.logger import init_logger
from vllm_module.utils import (cuda_device_count_stateless,
...
#  e.g. used by different vllm_module engines. The device id in the cache file is a
#  **local** device id, i.e. from 0 to num_dev-1, where num_dev is the number
#  of visible devices in the vllm_module engine.
...
def gpu_p2p_access_check(src: int, tgt: int) -> bool:
    ...
    from vllm_module.distributed.parallel_state import get_world_group
