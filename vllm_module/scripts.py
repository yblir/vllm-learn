...
from vllm_module.entrypoints.openai.api_server import run_server
...
def main():
    ...
    serve_parser = subparsers.add_parser(
        ...
        usage="vllm_module serve <model_tag> [options]")
    ...
    complete_parser = subparsers.add_parser(
        ...
        usage="vllm_module complete [options]")
    ...
    chat_parser = subparsers.add_parser(
        ...
        usage="vllm_module chat [options]")
