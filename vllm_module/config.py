...
from vllm_module.model_executor.layers.quantization import QUANTIZATION_METHODS
from vllm_module.model_executor.models import ModelRegistry
from vllm_module.tracing import is_otel_installed
from vllm_module.transformers_utils.config import get_config, get_hf_text_config
from vllm_module.utils import (cuda_device_count_stateless, get_cpu_memory, is_cpu,
...
if TYPE_CHECKING:
    ...
    from vllm_module.model_executor.model_loader.loader import BaseModelLoader
    from vllm_module.transformers_utils.tokenizer_group.base_tokenizer_group import (
        BaseTokenizerGroup)
