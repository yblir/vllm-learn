...
core_C_available = importlib.util.find_spec('._core_C', 'vllm_module') is not None
...
if TYPE_CHECKING or not core_C_available:
    ...
    try:
        import vllm_module._core_C  # noqa: F401
    except ImportError as e:
        logger.warning("Failed to import from vllm_module._core_C with %r", e)
