...
from vllm_module.config import SchedulerConfig
from vllm_module.core.scheduler import Scheduler
from vllm_module.engine.output_processor.stop_checker import StopChecker
from vllm_module.sequence import Sequence, SequenceGroup, SequenceGroupOutput
...
class SequenceGroupOutputProcessor(ABC):
    ...
    def create_output_processor(
        ...
        if scheduler_config.num_lookahead_slots == 0:
            ...
            from vllm_module.engine.output_processor.single_step import (
            ...
            # Importing here to avoid cycle.
            from vllm_module.engine.output_processor.multi_step import (
