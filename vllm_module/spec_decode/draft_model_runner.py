...
try:
    from vllm_module.attention.backends.flash_attn import FlashAttentionMetadata
except ModuleNotFoundError:
    # vllm_flash_attn is not installed, use the identical ROCm FA metadata
    from vllm_module.attention.backends.rocm_flash_attn import (
...
from vllm_module.multimodal import MultiModalInputs
from vllm_module.sequence import (ExecuteModelRequest, IntermediateTensors,
                                  SamplerOutput)
from vllm_module.worker.model_runner import (ModelInputForGPUWithSamplingMetadata,
                                             ModelRunner)
