...
from vllm_module._core_ext import ScalarType
from vllm_module.logger import init_logger

logger = init_logger(__name__)
# from vllm._C import ops
try:
    # import vllm_module._C
    import vllm._C
except ImportError as e:
    logger.warning("Failed to import from vllm_module._C with %r", e)

with contextlib.suppress(ImportError):
    # ruff: noqa: F401
    # import vllm_module._moe_C
    import vllm._moe_C
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            msg = (
                ...
                "Possibly you have built or installed an obsolete version of vllm_module.\n"
                "Please try a clean build and install of vllm_module,"
                "or remove old built files such as vllm_module/*cpython*.so and build/ ."
            )
...
def rms_norm(out: torch.Tensor, input: torch.Tensor, weight: torch.Tensor,
    ...
    # torch.nn.functional.rms_norm(out, input, weight, epsilon)
