...
from vllm_module.config import ModelConfig, ParallelConfig
...
class TensorizerAgent:
    ...
    in vllm_module/model_executor/model_loader/weight_utils.py
    """
    ...
    def __init__(self, tensorizer_config: TensorizerConfig,
        ...
        if tensorizer_error_msg is not None:
            raise ImportError(
                ...
                "to use this feature with `pip install vllm_module[tensorizer]`. "
