...
from vllm_module.model_executor.layers.fused_moe import FusedMoE, FusedMoEMethodBase
from vllm_module.model_executor.layers.linear import (LinearBase, LinearMethodBase,
                                                      UnquantizedLinearMethod)
from vllm_module.model_executor.layers.quantization.base_config import (
    QuantizationConfig, QuantizeMethodBase)
from vllm_module.model_executor.layers.quantization.kv_cache import BaseKVCacheMethod
from vllm_module.model_executor.layers.quantization.utils.marlin_utils_fp8 import (
    apply_fp8_marlin_linear, prepare_fp8_layer_for_marlin)
from vllm_module.model_executor.layers.quantization.utils.quant_utils import (
    is_layer_skipped)
from vllm_module.model_executor.layers.quantization.utils.w8a8_utils import (
...
class Fp8Config(QuantizationConfig):
    ...
    def get_quant_method(self, layer: torch.nn.Module,
        ...
        from vllm_module.attention.layer import Attention  # Avoid circular import
