...
from vllm_module.model_executor.models.gemma import GemmaModel
...
class PaliGemmaForConditionalGeneration(nn.Module, SupportsVision):
    ...
    # Copied from vllm_module/model_executor/models/gemma.py
    ...
    # Adapted from vllm_module/model_executor/models/gemma.py
        ...
        for name, loaded_weight in weights:
            ...
            if "vision" in name:
                ...
                for (param_name, shard_name,
                    ...
                    # lm_head is not used in vllm_module as it is tied with
