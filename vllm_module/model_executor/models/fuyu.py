...
from vllm_module.model_executor.models.persimmon import PersimmonForCausalLM
...
from vllm_module.multimodal.base import MultiModalInputs
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            if "query_key_value" in name:
                # copy from vllm_module/model_executor/models/bloom.py
