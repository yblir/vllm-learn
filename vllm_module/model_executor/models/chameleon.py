...
from vllm_module.attention import Attention, AttentionMetadata
from vllm_module.config import CacheConfig, MultiModalConfig
from vllm_module.distributed import get_tensor_model_parallel_world_size
from vllm_module.inputs import INPUT_REGISTRY, InputContext, LLMInputs
from vllm_module.logger import init_logger
from vllm_module.model_executor.layers.activation import SiluAndMul
from vllm_module.model_executor.layers.layernorm import RMSNorm
from vllm_module.model_executor.layers.linear import (MergedColumnParallelLinear,
                                                      QKVParallelLinear,
                                                      RowParallelLinear)
from vllm_module.model_executor.layers.logits_processor import LogitsProcessor
from vllm_module.model_executor.layers.quantization.base_config import (
    QuantizationConfig)
from vllm_module.model_executor.layers.rotary_embedding import get_rope
from vllm_module.model_executor.layers.sampler import Sampler
from vllm_module.model_executor.layers.vocab_parallel_embedding import (
    ParallelLMHead, VocabParallelEmbedding)
from vllm_module.model_executor.model_loader.weight_utils import default_weight_loader
from vllm_module.model_executor.sampling_metadata import SamplingMetadata
from vllm_module.multimodal import MULTIMODAL_REGISTRY
from vllm_module.multimodal.image import (cached_get_tokenizer,
                                          repeat_and_pad_image_tokens)
from vllm_module.sequence import IntermediateTensors, SamplerOutput, SequenceData
from vllm_module.utils import print_warning_once
...
# Copied from vllm_module.model_executor.models.llama.LlamaMLP -> ChameleonMLP
...
# Modified from vllm_module.model_executor.models.llama.LlamaAttention -> ChameleonAttention #noqa
