...
from vllm_module.attention import AttentionMetadata
...
from vllm_module.model_executor.layers.linear import ReplicatedLinear
...
from vllm_module.model_executor.layers.vocab_parallel_embedding import ParallelLMHead
from vllm_module.model_executor.model_loader.utils import set_default_torch_dtype
from vllm_module.model_executor.model_loader.weight_utils import default_weight_loader
from vllm_module.model_executor.models.interfaces import SupportsVision
from vllm_module.model_executor.models.llama import LlamaModel
from vllm_module.model_executor.models.minicpm import MiniCPMModel
from vllm_module.model_executor.models.qwen2 import Qwen2Model
...
from vllm_module.multimodal.image import (cached_get_image_processor,
...
class MiniCPMVQwen2(MiniCPMVBaseModel):
    ...
    def init_vision_module(self) -> nn.Module:
        ...
        from vllm_module.model_executor.models.na_vit import SiglipVisionTransformer
