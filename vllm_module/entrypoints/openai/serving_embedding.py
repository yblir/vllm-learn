...
from vllm_module.entrypoints.openai.protocol import (EmbeddingRequest,
                                                     EmbeddingResponse,
                                                     EmbeddingResponseData, UsageInfo)
from vllm_module.entrypoints.openai.serving_engine import OpenAIServing
from vllm_module.logger import init_logger
from vllm_module.outputs import EmbeddingRequestOutput
