...
from vllm_module.model_executor.guided_decoding.guided_fields import LLMGuidedOptions
...
from vllm_module.utils import Counter, deprecate_kwargs
...
class LLM:
    ...
    Args:
        ...
        **kwargs: Arguments for :class:`~vllm_module.EngineArgs`. (See
            :ref:`engine_args`)
    
    Note:
        This class is intended to be used for offline inference. For online
        serving, use the :class:`~vllm_module.AsyncLLMEngine` class instead.
    """
    ...
    def encode(
        ...
        Args:
            inputs: The inputs to the LLM. You may pass a sequence of inputs for
                batch inference. See :class:`~vllm_module.inputs.PromptInputs`
