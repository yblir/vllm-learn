...
if TYPE_CHECKING:
    from vllm_module.config import ModelConfig, MultiModalConfig
...
class InputRegistry:
    ...
    def dummy_data_for_profiling(self, model_config: "ModelConfig",
        ...
        """
        # Avoid circular import
        from vllm_module.model_executor.model_loader import get_model_architecture
    ...
    def register_input_processor(self, processor: InputProcessor):
        ...
        happens before :meth:`~vllm_module.multimodal.MultiModalRegistry.map_input`.
