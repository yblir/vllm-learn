...
from vllm_module.executor.distributed_gpu_executor import (  # yapf: disable
    DistributedGPUExecutor, DistributedGPUExecutorAsync)
from vllm_module.executor.ray_utils import RayWorkerWrapper, ray
from vllm_module.logger import init_logger
from vllm_module.sequence import ExecuteModelRequest, SamplerOutput
from vllm_module.utils import (_run_task_with_lock, get_distributed_init_method,
...
class RayGPUExecutor(DistributedGPUExecutor):
    ...
    def _get_worker_wrapper_args(self) -> Dict[str, Any]:
        if self.speculative_config is not None:
            ...
            worker_module_name = "vllm_module.worker.worker"
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup",
        ...
        def sort_by_driver_then_worker_ip(worker):
            ...
            1. If the worker is on the same node as the driver (vllm_module engine),
