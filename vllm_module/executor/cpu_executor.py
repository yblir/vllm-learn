...
from vllm_module.config import CacheConfig, ModelConfig, SchedulerConfig
from vllm_module.executor.executor_base import ExecutorAsyncBase, ExecutorBase
from vllm_module.executor.multiproc_worker_utils import (ProcessWorkerWrapper,
...
from vllm_module.utils import (get_distributed_init_method, get_open_port,
                               get_vllm_instance_id, make_async)
from vllm_module.worker.worker_base import WorkerWrapperBase
...
class CPUExecutor(ExecutorBase):
    ...
    def _create_worker(
        ...
        worker_module_name = "vllm_module.worker.cpu_worker"
