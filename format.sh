...
mypy vllm_module/attention --follow-imports skip
mypy vllm_module/core --follow-imports skip
mypy vllm_module/distributed --follow-imports skip
mypy vllm_module/engine  --follow-imports skip
mypy vllm_module/entrypoints --follow-imports skip
mypy vllm_module/executor --follow-imports skip
mypy vllm_module/lora --follow-imports skip
mypy vllm_module/model_executor  --follow-imports skip
mypy vllm_module/prompt_adapter --follow-imports skip
mypy vllm_module/spec_decode --follow-imports skip
mypy vllm_module/worker --follow-imports skip
echo 'vLLM mypy: Done'
