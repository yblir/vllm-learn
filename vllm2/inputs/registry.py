...
if TYPE_CHECKING:
    from vllm2.config import ModelConfig, MultiModalConfig
...
class InputRegistry:
    ...
    def dummy_data_for_profiling(self, model_config: "ModelConfig",
        ...
        """
        # Avoid circular import
        from vllm2.model_executor.model_loader import get_model_architecture
    ...
    def register_input_processor(self, processor: InputProcessor):
        ...
        happens before :meth:`~vllm2.multimodal.MultiModalRegistry.map_input`.
