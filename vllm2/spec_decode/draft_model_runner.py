...
try:
    from vllm2.attention.backends.flash_attn import FlashAttentionMetadata
except ModuleNotFoundError:
    # vllm_flash_attn is not installed, use the identical ROCm FA metadata
    from vllm2.attention.backends.rocm_flash_attn import (
...
from vllm2.multimodal import MultiModalInputs
