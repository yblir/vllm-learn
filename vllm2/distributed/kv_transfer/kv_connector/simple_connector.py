...
from vllm2.distributed.kv_transfer.kv_connector.base import KVConnectorBase
from vllm2.distributed.kv_transfer.kv_lookup_buffer.simple_buffer import (
    SimpleBuffer)
from vllm2.logger import init_logger
from vllm2.sequence import IntermediateTensors
...
class SimpleConnector(KVConnectorBase):
    ...
    def __init__(
        ...
        if self.config.kv_connector == "PyNcclConnector":
            from vllm2.distributed.kv_transfer.kv_pipe.pynccl_pipe import (
                PyNcclPipe)
            logger.info(
            ...
            if not use_mooncake_distributed_pipe:
                ...
                from vllm2.distributed.kv_transfer.kv_pipe.mooncake_pipe import (  # noqa: E501
                    MooncakePipe)
                logger.info(
