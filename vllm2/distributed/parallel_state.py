...
import vllm2.distributed.kv_transfer.kv_transfer_agent as kv_transfer
import vllm2.envs as envs
from vllm2.distributed.device_communicators.base_device_communicator import (
    DeviceCommunicatorBase)
from vllm2.distributed.utils import StatelessProcessGroup
from vllm2.logger import init_logger
from vllm2.utils import (direct_register_custom_op, resolve_obj_by_qualname,
                        supports_custom_op)
...
class GroupCoordinator:
    ...
    def __init__(
        ...
        from vllm2.distributed.device_communicators.shm_broadcast import (
            MessageQueue)
    ...
    def graph_capture(
        ...
        from vllm2.distributed.device_communicators.cuda_communicator import (
            CudaCommunicator)
