...
core_C_available = importlib.util.find_spec('._core_C', 'vllm2') is not None
...
if TYPE_CHECKING or not core_C_available:
    ...
    try:
        import vllm2._core_C  # noqa: F401
    except ImportError as e:
        logger.warning("Failed to import from vllm2._core_C with %r", e)
