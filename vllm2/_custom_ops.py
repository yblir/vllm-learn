...
from vllm2._core_ext import ScalarType
from vllm2.logger import init_logger

logger = init_logger(__name__)
# from vllm2._C import ops
try:
    # import vllm2._C
    import vllm2._C
except ImportError as e:
    logger.warning("Failed to import from vllm2._C with %r", e)
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            msg = (
                ...
                "Possibly you have built or installed an obsolete version of vllm2.\n"
                "Please try a clean build and install of vllm2,"
                "or remove old built files such as vllm2/*cpython*.so and build/ ."
            )
