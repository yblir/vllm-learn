...
from vllm2.attention import AttentionMetadata, get_attn_backend
from vllm2.config import (CacheConfig, DeviceConfig, LoadConfig, LoRAConfig,
                          ModelConfig, MultiModalConfig, ParallelConfig,
                          PromptAdapterConfig, SchedulerConfig)
from vllm2.distributed import get_pp_group
from vllm2.distributed.parallel_state import graph_capture
from vllm2.inputs import INPUT_REGISTRY
from vllm2.logger import init_logger
from vllm2.lora.layers import LoRAMapping
from vllm2.lora.request import LoRARequest
from vllm2.lora.worker_manager import LRUCacheWorkerLoRAManager
from vllm2.model_executor import SamplingMetadata
from vllm2.model_executor.model_loader import get_model
from vllm2.model_executor.model_loader.tensorizer import TensorizerConfig
from vllm2.model_executor.models.interfaces import (supports_lora,
                                                    supports_vision)
from vllm2.model_executor.models.utils import set_cpu_offload_max_bytes
from vllm2.multimodal import (MULTIMODAL_REGISTRY, BatchedTensorInputs,
                              MultiModalInputs)
from vllm2.prompt_adapter.layers import PromptAdapterMapping
from vllm2.prompt_adapter.request import PromptAdapterRequest
from vllm2.prompt_adapter.worker_manager import (
    LRUCacheWorkerPromptAdapterManager)
from vllm2.sampling_params import SamplingParams
from vllm2.sequence import (IntermediateTensors, SamplerOutput,
                            SequenceGroupMetadata)
from vllm2.utils import (CudaMemoryProfiler, flatten_2d_lists,
                         get_kv_cache_torch_dtype, is_hip,
                         is_pin_memory_available)
from vllm2.worker.model_runner_base import (
...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def save_tensorized_model(
        ...
        from vllm2.model_executor.model_loader.loader import TensorizerLoader
