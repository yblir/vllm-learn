...
from vllm2.model_executor import set_random_seed
from vllm2.sequence import ExecuteModelRequest, SamplerOutput
from vllm2.worker.openvino_model_runner import OpenVINOModelRunner
from vllm2.worker.worker_base import LoraNotSupportedWorkerBase
...
class OpenVINOWorker(LoraNotSupportedWorkerBase):
    ...
    def __init__(
        ...
        if self.model_config.trust_remote_code:
            ...
            from vllm2.utils import init_cached_hf_modules
