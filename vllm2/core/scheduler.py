...
from vllm2.sequence import (Sequence, SequenceData, SequenceGroup,
                            SequenceGroupMetadata, SequenceGroupMetadataDelta,
                            SequenceStage, SequenceStatus)
from vllm2.utils import Device, PyObjectCache
...
class Scheduler:
    ...
    def _schedule_running(
        ...
        while running_queue:
            ...
            while not self._can_append_slots(seq_group, enable_chunking):  # 如果不能为当前seq_group的每个seq都分配一个block
