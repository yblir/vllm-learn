...
from vllm2.entrypoints.openai.protocol import (
    ...
    CompletionRequest)
from vllm2.model_executor.guided_decoding.guided_fields import (
    GuidedDecodingRequest)
from vllm2.model_executor.guided_decoding.outlines_decoding import (
    get_local_outlines_guided_decoding_logits_processor,
    get_outlines_guided_decoding_logits_processor)
from vllm2.sampling_params import LogitsProcessor
...
async def get_guided_decoding_logits_processor(
    ...
    if guided_decoding_backend == 'lm-format-enforcer':
        from vllm2.model_executor.guided_decoding.lm_format_enforcer_decoding import (  # noqa
