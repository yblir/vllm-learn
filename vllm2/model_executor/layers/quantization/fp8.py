...
from vllm2.model_executor.layers.fused_moe import FusedMoE, FusedMoEMethodBase
from vllm2.model_executor.layers.linear import (LinearBase, LinearMethodBase,
                                                UnquantizedLinearMethod)
from vllm2.model_executor.layers.quantization.base_config import (
    QuantizationConfig, QuantizeMethodBase)
from vllm2.model_executor.layers.quantization.kv_cache import BaseKVCacheMethod
...
class Fp8Config(QuantizationConfig):
    ...
    def get_quant_method(self, layer: torch.nn.Module,
        ...
        from vllm2.attention.layer import Attention  # Avoid circular import
