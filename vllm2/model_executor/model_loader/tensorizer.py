...
from vllm2.config import ModelConfig, ParallelConfig
...
class TensorizerAgent:
    ...
    in vllm2/model_executor/model_loader/weight_utils.py
    """
    ...
    def __init__(self, tensorizer_config: TensorizerConfig,
        ...
        if tensorizer_error_msg is not None:
            raise ImportError(
                ...
                "to use this feature with `pip install vllm2[tensorizer]`. "
