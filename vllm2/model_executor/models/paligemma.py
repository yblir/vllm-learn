...
from vllm2.model_executor.models.gemma import GemmaModel
...
class PaliGemmaForConditionalGeneration(nn.Module, SupportsVision):
    ...
    # Copied from vllm2/model_executor/models/gemma.py
    ...
    # Adapted from vllm2/model_executor/models/gemma.py
        ...
        for name, loaded_weight in weights:
            ...
            if "vision" in name:
                ...
                for (param_name, shard_name,
                    ...
                    # lm_head is not used in vllm2 as it is tied with
