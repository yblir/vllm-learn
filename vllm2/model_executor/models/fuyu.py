...
from vllm2.model_executor.models.persimmon import PersimmonForCausalLM
from vllm2.model_executor.sampling_metadata import SamplingMetadata
from vllm2.multimodal import MULTIMODAL_REGISTRY
from vllm2.multimodal.base import MultiModalInputs
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            if "query_key_value" in name:
                # copy from vllm2/model_executor/models/bloom.py
