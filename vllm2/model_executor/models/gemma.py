...
from vllm2.config import CacheConfig, LoRAConfig
...
from vllm2.model_executor.layers.layernorm import GemmaRMSNorm
...
from vllm2.model_executor.layers.quantization.base_config import (
    QuantizationConfig)
from vllm2.model_executor.layers.rotary_embedding import GemmaRotaryEmbedding
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            for (param_name, shard_name, shard_id) in stacked_params_mapping:
                ...
                # lm_head is not used in vllm2 as it is tied with embed_token.
