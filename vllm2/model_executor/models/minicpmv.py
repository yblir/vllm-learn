...
from vllm2.config import CacheConfig, MultiModalConfig
from vllm2.inputs import INPUT_REGISTRY, InputContext, LLMInputs
from vllm2.logger import init_logger
from vllm2.model_executor.layers.linear import ReplicatedLinear
from vllm2.model_executor.layers.logits_processor import LogitsProcessor
from vllm2.model_executor.layers.quantization.base_config import (
    QuantizationConfig)
from vllm2.model_executor.layers.sampler import Sampler
from vllm2.model_executor.layers.vocab_parallel_embedding import ParallelLMHead
from vllm2.model_executor.model_loader.utils import set_default_torch_dtype
from vllm2.model_executor.model_loader.weight_utils import default_weight_loader
from vllm2.model_executor.models.interfaces import SupportsVision
from vllm2.model_executor.models.llama import LlamaModel
from vllm2.model_executor.models.minicpm import MiniCPMModel
from vllm2.model_executor.models.qwen2 import Qwen2Model
from vllm2.model_executor.sampling_metadata import SamplingMetadata
from vllm2.multimodal import MULTIMODAL_REGISTRY
from vllm2.multimodal.image import (cached_get_image_processor,
                                    cached_get_tokenizer)
from vllm2.sequence import IntermediateTensors, SamplerOutput, SequenceData
...
class MiniCPMVQwen2(MiniCPMVBaseModel):
    ...
    def init_vision_module(self) -> nn.Module:
        ...
        from vllm2.model_executor.models.na_vit import SiglipVisionTransformer
