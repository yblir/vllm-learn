...
from vllm2.attention import Attention, AttentionMetadata
from vllm2.config import CacheConfig, MultiModalConfig
from vllm2.distributed import get_tensor_model_parallel_world_size
...
from vllm2.model_executor.layers.linear import (MergedColumnParallelLinear,
                                                QKVParallelLinear,
                                                RowParallelLinear)
...
from vllm2.model_executor.layers.quantization.base_config import (
    QuantizationConfig)
from vllm2.model_executor.layers.rotary_embedding import get_rope
...
from vllm2.multimodal.image import (cached_get_tokenizer,
                                    repeat_and_pad_image_tokens)
from vllm2.sequence import IntermediateTensors, SamplerOutput, SequenceData
from vllm2.utils import print_warning_once
...
# Copied from vllm2.model_executor.models.llama.LlamaMLP -> ChameleonMLP
...
# Modified from vllm2.model_executor.models.llama.LlamaAttention -> ChameleonAttention #noqa
