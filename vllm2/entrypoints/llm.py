...
from vllm2.model_executor.guided_decoding.guided_fields import LLMGuidedOptions
from vllm2.outputs import EmbeddingRequestOutput, RequestOutput
...
from vllm2.utils import Counter, deprecate_kwargs
...
class LLM:
    ...
    Args:
        ...
        **kwargs: Arguments for :class:`~vllm2.EngineArgs`. (See
            :ref:`engine_args`)

    Note:
        This class is intended to be used for offline inference. For online
        serving, use the :class:`~vllm2.AsyncLLMEngine` class instead.
    """
    ...
    def encode(
        ...
        Args:
            inputs: The inputs to the LLM. You may pass a sequence of inputs for
                batch inference. See :class:`~vllm2.inputs.PromptInputs`
