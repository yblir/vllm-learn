...
from vllm2.entrypoints.chat_utils import (ConversationMessage,
                                          load_chat_template,
                                          parse_chat_messages)
from vllm2.entrypoints.logger import RequestLogger
from vllm2.entrypoints.openai.protocol import (
...
from vllm2.entrypoints.openai.serving_engine import (LoRAModulePath,
                                                     OpenAIServing,
                                                     PromptAdapterPath)
from vllm2.inputs import PromptInputs
...
from vllm2.sequence import Logprob
from vllm2.tracing import (contains_trace_headers, extract_trace_headers,
                           log_tracing_disabled_warning)
from vllm2.utils import random_uuid
...
class OpenAIServingChat(OpenAIServing):
    ...
    async def create_chat_completion(
        ...
        try:
            ...
            # TODO: Use a vllm2-specific Validation Error
            return self.create_error_response(str(e))
