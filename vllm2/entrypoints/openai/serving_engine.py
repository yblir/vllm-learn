...
from vllm2.entrypoints.openai.protocol import (ChatCompletionRequest,
                                               ...
                                               TokenizeRequest)
# yapf: enable
from vllm2.inputs import parse_and_batch_prompt
...
from vllm2.sampling_params import LogitsProcessor, SamplingParams
from vllm2.sequence import Logprob
from vllm2.transformers_utils.tokenizer_group import AnyTokenizer
