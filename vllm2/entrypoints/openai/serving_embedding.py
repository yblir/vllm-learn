...
from vllm2.entrypoints.openai.protocol import (EmbeddingRequest,
                                               EmbeddingResponse,
                                               EmbeddingResponseData, UsageInfo)
from vllm2.entrypoints.openai.serving_engine import OpenAIServing
from vllm2.logger import init_logger
from vllm2.outputs import EmbeddingRequestOutput
