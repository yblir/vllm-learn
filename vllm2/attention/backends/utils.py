...
from vllm2.attention import (AttentionMetadata, AttentionMetadataBuilder,
                            AttentionState)
from vllm2.attention.backends.abstract import AttentionType
from vllm2.logger import logging
from vllm2.multimodal import MultiModalPlaceholderMap
from vllm2.platforms import current_platform
from vllm2.utils import async_tensor_h2d, make_tensor_with_pad

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from vllm2.worker.model_runner_base import ModelRunnerBase
...
def get_flash_attn_version():
    try:
        from vllm2.vllm_flash_attn.flash_attn_interface import (
