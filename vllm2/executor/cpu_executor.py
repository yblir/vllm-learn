...
from vllm2.config import CacheConfig, ModelConfig, SchedulerConfig
from vllm2.executor.executor_base import ExecutorAsyncBase, ExecutorBase
from vllm2.executor.multiproc_worker_utils import (ProcessWorkerWrapper,
...
from vllm2.sequence import ExecuteModelRequest, SamplerOutput
from vllm2.utils import (get_distributed_init_method, get_open_port,
                         get_vllm_instance_id, make_async)
from vllm2.worker.worker_base import WorkerWrapperBase
...
class CPUExecutor(ExecutorBase):
    ...
    def _create_worker(
        ...
        worker_module_name = "vllm2.worker.cpu_worker"
