...
from vllm2.executor.distributed_gpu_executor import (  # yapf: disable
    DistributedGPUExecutor, DistributedGPUExecutorAsync)
from vllm2.executor.ray_utils import RayWorkerWrapper, ray
from vllm2.logger import init_logger
from vllm2.sequence import ExecuteModelRequest, SamplerOutput
from vllm2.utils import (_run_task_with_lock, get_distributed_init_method,
...
class RayGPUExecutor(DistributedGPUExecutor):
    ...
    def _get_worker_wrapper_args(self) -> Dict[str, Any]:
        if self.speculative_config is not None:
            worker_module_name = "vllm2.spec_decode.spec_decode_worker"
            worker_class_name = "create_spec_worker"
        else:
            worker_module_name = "vllm2.worker.worker"
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup",
        ...
        def sort_by_driver_then_worker_ip(worker):
            ...
            1. If the worker is on the same node as the driver (vllm2 engine),
