...
from vllm2.config import (DecodingConfig, LoRAConfig, ModelConfig,
                         ObservabilityConfig, ParallelConfig, SchedulerConfig,
                         VllmConfig)
from vllm2.core.scheduler import ScheduledSequenceGroup, SchedulerOutputs
from vllm2.engine.arg_utils import EngineArgs
from vllm2.engine.metrics_types import StatLoggerBase, Stats
from vllm2.engine.output_processor.interfaces import (
    SequenceGroupOutputProcessor)
from vllm2.engine.output_processor.stop_checker import StopChecker
from vllm2.engine.output_processor.util import create_output_by_sequence_group
from vllm2.entrypoints.openai.logits_processors import (
    get_logits_processors as get_openai_logits_processors)
from vllm2.executor.executor_base import ExecutorBase
from vllm2.inputs import (INPUT_REGISTRY, InputRegistry, ProcessorInputs,
                         PromptType, SingletonInputsAdapter)
from vllm2.inputs.parse import is_encoder_decoder_inputs, is_token_prompt
from vllm2.inputs.preprocess import InputPreprocessor
from vllm2.logger import init_logger
from vllm2.logits_process import get_bad_words_logits_processors
from vllm2.lora.request import LoRARequest
from vllm2.model_executor.guided_decoding import (
    get_local_guided_decoding_logits_processor)
from vllm2.model_executor.layers.sampler import SamplerOutput
from vllm2.multimodal import MULTIMODAL_REGISTRY, MultiModalRegistry
from vllm2.outputs import (PoolingRequestOutput, RequestOutput,
                          RequestOutputFactory)
from vllm2.pooling_params import PoolingParams
from vllm2.prompt_adapter.request import PromptAdapterRequest
from vllm2.sampling_params import RequestOutputKind, SamplingParams
from vllm2.sequence import (ExecuteModelRequest, ParallelSampleSequenceGroup,
                           PoolingSequenceGroupOutput, Sequence, SequenceGroup,
                           SequenceGroupBase, SequenceGroupMetadata,
                           SequenceGroupOutput, SequenceStatus)
from vllm2.tracing import (SpanAttributes, SpanKind, extract_trace_context,
                          init_tracer)
from vllm2.transformers_utils.detokenizer import Detokenizer
from vllm2.transformers_utils.tokenizer import AnyTokenizer
from vllm2.transformers_utils.tokenizer_group import (
    BaseTokenizerGroup, init_tokenizer_from_configs)
from vllm2.usage.usage_lib import (UsageContext, is_usage_stats_enabled,
                                  usage_message)
from vllm2.utils import (Counter, Device, deprecate_kwargs,
                        resolve_obj_by_qualname, weak_bind)
from vllm2.version import __version__ as VLLM_VERSION
...
class LLMEngine:
    ...
    def __init__(
        ...
        if is_usage_stats_enabled():
            from vllm2.model_executor.model_loader import (
        ...
        if self.log_stats:
            if stat_loggers is not None:
                ...
                from vllm2.engine.metrics import (LoggingStatLogger,
    ...
    def _get_executor_cls(cls,
        ...
        if isinstance(distributed_executor_backend, type):
            ...
            from vllm2.executor.ray_distributed_executor import (
                RayDistributedExecutor)
            executor_class = RayDistributedExecutor
        elif distributed_executor_backend == "mp":
            from vllm2.executor.mp_distributed_executor import (
            ...
            from vllm2.executor.uniproc_executor import UniProcExecutor
            executor_class = UniProcExecutor
        elif distributed_executor_backend == "external_launcher":
            # executor with external launcher
            from vllm2.executor.uniproc_executor import (  # noqa
    ...
    def add_request(
            ...
            params: Optional[Union[SamplingParams, PoolingParams]] = None,  # 用于采样的参数（温度、topk等）
