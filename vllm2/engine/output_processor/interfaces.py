...
from vllm2.config import SchedulerConfig
from vllm2.core.scheduler import Scheduler
from vllm2.engine.output_processor.stop_checker import StopChecker
from vllm2.sequence import Sequence, SequenceGroup, SequenceGroupOutput
...
class SequenceGroupOutputProcessor(ABC):
    ...
    def create_output_processor(
        ...
        if scheduler_config.num_lookahead_slots == 0:
            ...
            from vllm2.engine.output_processor.single_step import (
            ...
            # Importing here to avoid cycle.
            from vllm2.engine.output_processor.multi_step import (
