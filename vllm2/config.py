...
from vllm2.model_executor.layers.quantization import QUANTIZATION_METHODS
from vllm2.model_executor.models import ModelRegistry
from vllm2.tracing import is_otel_installed
from vllm2.transformers_utils.config import get_config, get_hf_text_config
from vllm2.utils import (cuda_device_count_stateless, get_cpu_memory, is_cpu,
...
if TYPE_CHECKING:
    ...
    from vllm2.model_executor.model_loader.loader import BaseModelLoader
    from vllm2.transformers_utils.tokenizer_group.base_tokenizer_group import (
        BaseTokenizerGroup)
...
class ParallelConfig:
    ...
    def __init__(
        ...
        if self.distributed_executor_backend is None and self.world_size > 1:
            ...
            from vllm2.executor import ray_utils
            backend = "mp"
