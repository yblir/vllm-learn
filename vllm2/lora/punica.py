...
from vllm2.triton_utils import HAS_TRITON

if HAS_TRITON:
    from vllm2.lora.ops.bgmv_expand import bgmv_expand
    from vllm2.lora.ops.bgmv_expand_slice import bgmv_expand_slice
    from vllm2.lora.ops.bgmv_shrink import bgmv_shrink
    from vllm2.lora.ops.sgmv_expand import sgmv_expand
    from vllm2.lora.ops.sgmv_expand_slice import sgmv_expand_slice
    from vllm2.lora.ops.sgmv_shrink import sgmv_shrink

if TYPE_CHECKING:
    # avoid circuit import
    from vllm2.lora.layers import LoRAMapping
    from vllm2.lora.models import LongContextLoRAContext
