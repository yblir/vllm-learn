...
```bash
vllm_module serve NousResearch/Meta-Llama-3-8B-Instruct --dtype auto --api-key token-abc123
```
...
```bash
vllm_module serve <model> --chat-template ./path-to-chat-template.jinja
```
