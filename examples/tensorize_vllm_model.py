...
from vllm_module.model_executor.model_loader.tensorizer import (TensorizerArgs,
                                                                TensorizerConfig,
...
libsodium must be installed to use it. Install vllm_module with tensorizer support 
using `pip install vllm_module[tensorizer]`. To learn more about tensorizer, visit
...
python -m examples.tensorize_vllm_model \
   ...
   --dtype float16 \
   deserialize \
   --path-to-tensors s3://my-bucket/vllm_module/EleutherAI/gpt-j-6B/v1/model.tensors
...
def parse_args():
    ...
    serialize_parser.add_argument(
        ...
        help=(
            ...
            "saved to "
            "`s3://my-bucket/vllm_module/EleutherAI/gpt-j-6B/v1/model.tensors`. "
    ...
    serialize_parser.add_argument(
        ...
        "be saved to `dir/vllm_module/EleutherAI/gpt-j-6B/suffix/model.tensors`, "
...
if __name__ == '__main__':
    ...
    if args.command == "serialize":
        ...
        base_path = f"{input_dir}/vllm_module/{model_ref}/{suffix}"
