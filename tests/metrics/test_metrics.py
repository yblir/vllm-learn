...
def assert_metrics(engine: LLMEngine, disable_log_stats: bool,
    ...
    if disable_log_stats:
        ...
        request_histogram_metrics = [
            "vllm_module:e2e_request_latency_seconds",
            "vllm_module:request_prompt_tokens",
            "vllm_module:request_generation_tokens",
            "vllm_module:request_params_best_of",
            "vllm_module:request_params_n",
        ]
