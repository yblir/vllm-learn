...
from vllm2.model_executor.model_loader.loader import get_model_loader
from vllm2.platforms import current_platform
from vllm2.transformers_utils.tokenizer import get_tokenizer
from vllm2.utils import (FlexibleArgumentParser, GB_bytes,
...
if current_platform.is_rocm():
    ...
    from vllm2.third_party.pynvml import (nvmlDeviceGetHandleByIndex,
