...
from vllm_module.model_executor.layers.ops.sample import (_sample_triton,
                                                          _uniform_to_exponential,
                                                          sample)
from vllm_module.model_executor.sampling_metadata import SamplingTensors
from vllm_module.model_executor.utils import set_random_seed
from vllm_module.triton_utils.libentry import LibEntry
from vllm_module.triton_utils.sample import (MAX_TRITON_N_COLS,
...
def test_sample_decoding_only(random_sampling, max_best_of,
    ...
    with patch("vllm_module.model_executor.layers.ops.sample._sample_triton",
