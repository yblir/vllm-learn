...
from vllm2.attention import AttentionBackend, AttentionMetadata, AttentionType
from vllm2.model_executor.layers.activation import SiluAndMul
from vllm2.platforms.interface import _Backend
from vllm2.utils import (STR_BACKEND_ENV_VAR, STR_FLASH_ATTN_VAL,
...
def make_backend(backend_name: str) -> AttentionBackend:
    ...
    * Backend instance
    ...
    if backend_name == STR_XFORMERS_ATTN_VAL:
        ...
        from vllm2.attention.backends.xformers import XFormersBackend
        return XFormersBackend()
    elif backend_name == STR_FLASH_ATTN_VAL:
        from vllm2.attention.backends.flash_attn import FlashAttentionBackend
