...
from vllm2.transformers_utils.tokenizer import patch_padding_side
...
def h2ovl_patch_hf_runner(hf_model: HfRunner) -> HfRunner:
    ...
    class H2OVLProcessor:
        ...
        def __call__(self, text: str, images: Union[Image, List[Image]],
                     **kwargs):
            # yapf: disable
            from vllm2.model_executor.models.h2ovl import (
...
def internvl_patch_hf_runner(hf_model: HfRunner) -> HfRunner:
    ...
    class InternVLProcessor:
        ...
        def __call__(self, text: str, images: Union[Image, List[Image]],
                     **kwargs):
            from vllm2.model_executor.models.internvl import (
