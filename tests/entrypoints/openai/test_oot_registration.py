...
from vllm_module import ModelRegistry
from vllm_module.model_executor.models.opt import OPTForCausalLM
from vllm_module.model_executor.sampling_metadata import SamplingMetadata
from vllm_module.utils import get_open_port
...
def server_function(port):
    ...
    import runpy
    runpy.run_module('vllm_module.entrypoints.openai.api_server', run_name='__main__')
