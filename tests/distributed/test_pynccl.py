...
from vllm_module.distributed.communication_op import (  # noqa
    tensor_model_parallel_all_reduce)
from vllm_module.distributed.device_communicators.pynccl import PyNcclCommunicator
from vllm_module.distributed.device_communicators.pynccl_wrapper import NCCLLibrary
from vllm_module.distributed.parallel_state import (ensure_model_parallel_initialized,
                                                    get_world_group, graph_capture,
                                                    init_distributed_environment)
from vllm_module.utils import update_environment_variables
...
def test_pynccl_multiple_allreduce_with_vllm():
    # this tests pynccl for multiple tp groups, together with vllm_module
