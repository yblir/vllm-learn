...
from vllm_module.lora.ops.bgmv_expand import bgmv_expand
from vllm_module.lora.ops.bgmv_expand_slice import bgmv_expand_slice
from vllm_module.lora.ops.bgmv_shrink import bgmv_shrink
from vllm_module.lora.ops.sgmv_expand import sgmv_expand
from vllm_module.lora.ops.sgmv_expand_slice import sgmv_expand_slice
from vllm_module.lora.ops.sgmv_shrink import sgmv_shrink
from vllm_module.triton_utils.libentry import LibEntry
...
def test_punica_bgmv(
    ...
    from vllm_module.lora.ops.bgmv_expand import _bgmv_expand_kernel
    from vllm_module.lora.ops.bgmv_shrink import _bgmv_shrink_kernel
    ...
    if op_type == "shrink":
        ...
        with patch(
                "vllm_module.lora.ops.bgmv_shrink._bgmv_shrink_kernel",
        ...
        # ditto
        with patch(
                "vllm_module.lora.ops.bgmv_expand._bgmv_expand_kernel",
...
def test_punica_expand_nslices(
    ...
    from vllm_module.lora.ops.bgmv_expand_slice import _bgmv_expand_slice_kernel
    ...
    for index in range(nslices):
        ...
        if op_type == "sgmv":
            ...
            with patch(
                    "vllm_module.lora.ops.bgmv_expand_slice._bgmv_expand_slice_kernel",
