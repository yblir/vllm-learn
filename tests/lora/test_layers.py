...
from vllm_module.config import LoRAConfig
from vllm_module.lora.fully_sharded_layers import (
...
# yapf: disable
from vllm_module.lora.layers import (BaseLayerWithLoRA, ColumnParallelLinearWithLoRA,
...
# yapf: enable
from vllm_module.lora.models import (LongContextLoRAContext, LoRALayerWeights,
                                     PackedLoRALayerWeights)
from vllm_module.lora.punica import PunicaWrapper
...
def test_vocab_parallel_embedding_indices(tp_size, seed):
    ...
    for tp_rank in range(tp_size):
        with patch(
                "vllm_module.model_executor.layers.vocab_parallel_embedding.get_tensor_model_parallel_rank",
                return_value=tp_rank
        ), patch(
                "vllm_module.model_executor.layers.vocab_parallel_embedding.get_tensor_model_parallel_world_size",
