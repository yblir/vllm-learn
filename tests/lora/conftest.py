...
from vllm_module.distributed import (destroy_distributed_environment,
...
def llama_2_7b_engine_extra_embeddings():
    ...
    with patch("vllm_module.worker.model_runner.get_model", get_model_patched):
        engine = vllm_module.LLM("meta-llama/Llama-2-7b-hf", enable_lora=False)
