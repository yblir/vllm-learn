...
from vllm2.config import ParallelConfig, VllmConfig, set_current_vllm_config
from vllm2.utils import (FlexibleArgumentParser, MemorySnapshot,
...
def test_memory_profiling():
    ...
    from vllm2.distributed.device_communicators.cuda_wrapper import (
        CudaRTLibrary)
    lib = CudaRTLibrary()
...
def test_bind_kv_cache_encoder_decoder():
    from vllm2.attention import Attention, AttentionType
...
def test_bind_kv_cache_pp():
    with patch("vllm2.utils.cuda_device_count_stateless", lambda: 2):
