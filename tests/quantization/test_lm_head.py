...
from vllm_module.model_executor.layers.linear import UnquantizedLinearMethod
from vllm_module.model_executor.layers.quantization.gptq import GPTQLinearMethod
from vllm_module.model_executor.layers.quantization.gptq_marlin import (
    GPTQMarlinLinearMethod)
from vllm_module.model_executor.layers.quantization.marlin import MarlinLinearMethod
