...
SystemEnv = namedtuple(
    ...
    [
        ...
        'cpu_info',
        'rocm_version',  # vllm_module specific field
        'neuron_sdk_version',  # vllm_module specific field
        'vllm_version',  # vllm_module specific field
        'vllm_build_flags',  # vllm_module specific field
        'gpu_topo',  # vllm_module specific field
    ])
...
def get_vllm_version():
    try:
        import vllm_module
        return vllm_module.__version__
    except ImportError:
        return 'N/A'
